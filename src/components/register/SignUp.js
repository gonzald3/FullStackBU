...
function SignUp(props) {
  ...
  const createUser = async ({ userUuid, email, password, fullname }) => {
    ...
    const url = 'https://morning-lowlands-96711.herokuapp.com/users/create';
    ...
    <div>
      <div>
        ...
        <div >
          {userAvatar && <div>
            <div>
              <img width="10%" src={userAvatar} alt="user-avatar" />
              <svg width="10%" onClick={removeUserAvatar} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" fill="currentColor">
